...
<nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    ...
    <div class="container section-t8">
            <h3>Visit Deadline in 4 weeks</h3>

    <div class="accordion" id="accordionExample">
        @foreach($data as $patient)
            <?php
                $st=Carbon::parse($patient->deadline);
                $d= Carbon::now();
                $diff=$d->diffInDays($st);
            ?>
            ...
            @if($diff<=28)
                ...
                <div class="card">
                    ...
                    <div id="collapse-{{$patient->id}}" class="collapse show" aria-labelledby="heading-{{$patient->name}}" data-parent="#accordionExample">
                        <div class="card-body">
                        <ul class="list-group">
                            <li class="list-group-item d-flex">Age: {{$patient->age}}</li>
                            <li class="list-group-item d-flex">Phone: {{$patient->phone}}</li>
                            <li class="list-group-item d-flex">Start Date: {{$patient->start_date}}</li>
                            <li class="list-group-item d-flex">DeadLine: {{$patient->deadline}}</li>
                            <?php
                                $st=Carbon::parse($patient->deadline);
                                $d= Carbon::now();
                                $diff=$d->diffInDays($st);
                            ?>
                            <li class="list-group-item d-flex">Days Left For Visit:{{$diff}}</li>
                        </ul>
                        </div>
                    </div>
                </div>
