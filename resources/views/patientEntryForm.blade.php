...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container section-t8">
            <h3>Profile</h3>
    <form class="form" action="patientSave" method="post" id="userProfileForm">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="form-group">
                    <div class="col-xs-6">
                        <label for="follow_up"><strong>Follow Up</strong></label>
                        <input type="date" class="form-control" name="follow_up" value="" >
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-xs-12">
